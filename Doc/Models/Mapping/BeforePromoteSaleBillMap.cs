...
{
    public class BeforePromoteSaleBillMap : EntityTypeConfiguration<BeforePromoteSaleBill>
    {
        public BeforePromoteSaleBillMap()
        {
            // Primary Key
            this.HasKey(t => new { t.BillNumberId, t.ID, t.IsUnit2, t.IsGift });
            ...
            this.ToTable("BeforePromoteSaleBill");
