...
{
    public class vWeb_OrderBillIndex_NoBillStopMap : EntityTypeConfiguration<vWeb_OrderBillIndex_NoBillStop>
    {
        public vWeb_OrderBillIndex_NoBillStopMap()
        {
            // Primary Key
            this.HasKey(t => new { t.billNumberId, t.BillDate, t.Billcode, t.billtype, t.OrderState, t.ARLimitTime, t.PaymentLTime, t.SName });
            ...
            this.Property(t => t.ARLimitTime)
                .HasDatabaseGeneratedOption(DatabaseGeneratedOption.None);

            this.Property(t => t.PaymentLTime)
                .HasDatabaseGeneratedOption(DatabaseGeneratedOption.None);
            ...
            this.ToTable("vWeb_OrderBillIndex_NoBillStop");
            ...
            this.Property(t => t.checkeman).HasColumnName("checkeman");
