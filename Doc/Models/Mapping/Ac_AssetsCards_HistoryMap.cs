...
{
    public class Ac_AssetsCards_HistoryMap : EntityTypeConfiguration<Ac_AssetsCards_History>
    {
        public Ac_AssetsCards_HistoryMap()
        {
            // Primary Key
            ...
            this.ToTable("Ac_AssetsCards_History");
