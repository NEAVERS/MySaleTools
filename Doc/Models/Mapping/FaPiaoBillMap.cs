...
{
    public class FaPiaoBillMap : EntityTypeConfiguration<FaPiaoBill>
    {
        public FaPiaoBillMap()
        {
            // Primary Key
            ...
            this.Property(t => t.Nberoretotal).HasColumnName("Nberoretotal");
