...
{
    public class OtherInOutBillMap : EntityTypeConfiguration<OtherInOutBill>
    {
        public OtherInOutBillMap()
        {
            // Primary Key
            this.HasKey(t => new { t.BillNumberId, t.BillType, t.IsUnit2, t.ID });
