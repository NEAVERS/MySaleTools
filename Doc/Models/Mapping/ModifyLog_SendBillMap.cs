...
{
    public class ModifyLog_SendBillMap : EntityTypeConfiguration<ModifyLog_SendBill>
    {
        public ModifyLog_SendBillMap()
        {
            // Primary Key
            this.HasKey(t => new { t.BillNumberId, t.ID, t.IsGift, t.PriceStyle });
            ...
            this.ToTable("ModifyLog_SendBill");
