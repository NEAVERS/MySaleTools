...
{
    public class CM_FeeIndexMap : EntityTypeConfiguration<CM_FeeIndex>
    {
        public CM_FeeIndexMap()
        {
            // Primary Key
            this.HasKey(t => new { t.BillNumberId, t.BillDate, t.BillCode, t.BillType, t.CarId, t.Stypeid, t.Etypeid, t.Dtypeid });
