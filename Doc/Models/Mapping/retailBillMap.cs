...
{
    public class retailBillMap : EntityTypeConfiguration<retailBill>
    {
        public retailBillMap()
        {
            // Primary Key
            this.HasKey(t => new { t.BillNumberId, t.ID, t.IsUnit2, t.IsGift, t.PosId, t.PriceDetailId, t.PriceRuleId, t.PriceSource, t.PriceStyle, t.PromoType });
            ...
            this.Property(t => t.PriceDetailId)
                .HasDatabaseGeneratedOption(DatabaseGeneratedOption.None);
            ...
            this.Property(t => t.PriceDetailId).HasColumnName("PriceDetailId");
