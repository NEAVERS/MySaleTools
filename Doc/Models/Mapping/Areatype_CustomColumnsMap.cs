...
{
    public class Areatype_CustomColumnsMap : EntityTypeConfiguration<Areatype_CustomColumns>
    {
        public Areatype_CustomColumnsMap()
        {
            // Primary Key
            this.HasKey(t => t.ID);
            ...
            this.ToTable("Areatype_CustomColumns");
