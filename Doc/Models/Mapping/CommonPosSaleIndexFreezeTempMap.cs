...
namespace Test.Models.Mapping
{
    public class CommonPosSaleIndexFreezeTempMap : EntityTypeConfiguration<CommonPosSaleIndexFreezeTemp>
    {
        public CommonPosSaleIndexFreezeTempMap()
        {
            ...
            this.ToTable("CommonPosSaleIndexFreezeTemp");
