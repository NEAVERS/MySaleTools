...
{
    public class QuotePriceBillMap : EntityTypeConfiguration<QuotePriceBill>
    {
        public QuotePriceBillMap()
        {
            // Primary Key
            ...
            this.Property(t => t.CurRate).HasColumnName("CurRate");
            ...
            this.Property(t => t.ExpectedInterest).HasColumnName("ExpectedInterest");
            this.Property(t => t.ExpectedInterestRate).HasColumnName("ExpectedInterestRate");
