...
{
    public class ModifyLog_BuyBillMap : EntityTypeConfiguration<ModifyLog_BuyBill>
    {
        public ModifyLog_BuyBillMap()
        {
            // Primary Key
            this.HasKey(t => new { t.BillNumberId, t.ID, t.orderid, t.IsUnit2, t.IsGift });
            ...
            this.ToTable("ModifyLog_BuyBill");
