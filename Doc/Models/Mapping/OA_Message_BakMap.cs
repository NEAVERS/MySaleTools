...
{
    public class OA_Message_BakMap : EntityTypeConfiguration<OA_Message_Bak>
    {
        public OA_Message_BakMap()
        {
            // Primary Key
            this.HasKey(t => new { t.ID, t.AttachmentID, t.IsRead, t.Docking, t.SortOrder, t.MessageType });
            ...
            this.Property(t => t.InviteURL)
                .HasMaxLength(500);

            // Table & Column Mappings
            this.ToTable("OA_Message_Bak");
            ...
            this.Property(t => t.InviteURL).HasColumnName("InviteURL");
        }
    }
}
