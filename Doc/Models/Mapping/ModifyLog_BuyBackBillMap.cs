...
{
    public class ModifyLog_BuyBackBillMap : EntityTypeConfiguration<ModifyLog_BuyBackBill>
    {
        public ModifyLog_BuyBackBillMap()
        {
            // Primary Key
            this.HasKey(t => new { t.BillNumberId, t.ID, t.IsUnit2, t.IsGift, t.PriceStyle });
            ...
            this.ToTable("ModifyLog_BuyBackBill");
