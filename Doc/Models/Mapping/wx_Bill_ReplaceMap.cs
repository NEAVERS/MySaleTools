...
{
    public class wx_Bill_ReplaceMap : EntityTypeConfiguration<wx_Bill_Replace>
    {
        public wx_Bill_ReplaceMap()
        {
            // Primary Key
            ...
            this.Property(t => t.wxProperty).HasColumnName("wxProperty");
