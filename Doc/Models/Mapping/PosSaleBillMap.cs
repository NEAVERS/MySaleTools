...
{
    public class PosSaleBillMap : EntityTypeConfiguration<PosSaleBill>
    {
        public PosSaleBillMap()
        {
            // Primary Key
            this.HasKey(t => new { t.ID, t.PromoType, t.SaleEid, t.producedate, t.validdate, t.goodsnumber, t.serial });
