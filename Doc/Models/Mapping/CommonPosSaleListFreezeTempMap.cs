...
{
    public class CommonPosSaleListFreezeTempMap : EntityTypeConfiguration<CommonPosSaleListFreezeTemp>
    {
        public CommonPosSaleListFreezeTempMap()
        {
            // Primary Key
            this.HasKey(t => new { t.PosVchCode, t.ListID, t.PtypeID, t.Qty, t.RetailPrice, t.DisCount, t.DisCountRate, t.Price, t.Sum, t.IsPresent, t.CXBillID, t.CXJFXS, t.IsUpSend, t.UpLoadPosVchCode, t.UniqueID });
            ...
            this.ToTable("CommonPosSaleListFreezeTemp");
