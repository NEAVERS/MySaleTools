...
{
    public class vWeb_OrderBillIndexMap : EntityTypeConfiguration<vWeb_OrderBillIndex>
    {
        public vWeb_OrderBillIndexMap()
        {
            // Primary Key
            this.HasKey(t => new { t.billNumberId, t.BName, t.BillDate, t.Billcode, t.EName1, t.KName, t.DName, t.billtype, t.EName2, t.OrderState, t.ARLimitTime, t.PaymentLTime, t.SName });
            ...
            this.ToTable("vWeb_OrderBillIndex");
