...
{
    public class ModifyLog_SaleBillMap : EntityTypeConfiguration<ModifyLog_SaleBill>
    {
        public ModifyLog_SaleBillMap()
        {
            // Primary Key
            this.HasKey(t => new { t.BillNumberId, t.ID, t.IsUnit2, t.IsGift, t.BeforePromoID, t.PriceStyle, t.PromoType });
            ...
            this.Property(t => t.BeforePromoID)
                .HasDatabaseGeneratedOption(DatabaseGeneratedOption.None);
            ...
            this.ToTable("ModifyLog_SaleBill");
            ...
            this.Property(t => t.BeforePromoID).HasColumnName("BeforePromoID");
            ...
            this.Property(t => t.LendBillNumberID).HasColumnName("LendBillNumberID");
            this.Property(t => t.LendBillID).HasColumnName("LendBillID");
