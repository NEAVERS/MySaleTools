...
{
    public class PriceTrack_SType_QuoteMap : EntityTypeConfiguration<PriceTrack_SType_Quote>
    {
        public PriceTrack_SType_QuoteMap()
        {
            // Primary Key
            ...
            this.ToTable("PriceTrack_SType_Quote");
