...
{
    public class ModifyLog_SaleBackBillMap : EntityTypeConfiguration<ModifyLog_SaleBackBill>
    {
        public ModifyLog_SaleBackBillMap()
        {
            // Primary Key
            ...
            this.ToTable("ModifyLog_SaleBackBill");
