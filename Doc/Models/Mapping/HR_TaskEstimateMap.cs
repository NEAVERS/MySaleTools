...
{
    public class HR_TaskEstimateMap : EntityTypeConfiguration<HR_TaskEstimate>
    {
        public HR_TaskEstimateMap()
        {
            // Primary Key
            this.HasKey(t => new { t.ID, t.Task_ID, t.Person_ID, t.HR_ID });
