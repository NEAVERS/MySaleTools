...
{
    public class BeforePromoteRetailBillMap : EntityTypeConfiguration<BeforePromoteRetailBill>
    {
        public BeforePromoteRetailBillMap()
        {
            // Primary Key
            this.HasKey(t => new { t.BillNumberId, t.ID, t.IsUnit2, t.IsGift, t.PriceDetailId, t.PriceRuleId, t.PriceSource, t.etypeid });
            ...
            this.ToTable("BeforePromoteRetailBill");
