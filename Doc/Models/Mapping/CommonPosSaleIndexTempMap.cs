...
{
    public class CommonPosSaleIndexTempMap : EntityTypeConfiguration<CommonPosSaleIndexTemp>
    {
        public CommonPosSaleIndexTempMap()
        {
            // Primary Key
            ...
            this.ToTable("CommonPosSaleIndexTemp");
