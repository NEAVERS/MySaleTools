...
{
    public class GivemeBillMap : EntityTypeConfiguration<GivemeBill>
    {
        public GivemeBillMap()
        {
            // Primary Key
            this.HasKey(t => new { t.BillNumberId, t.IsUnit2, t.ID, t.KTypeId });
