...
{
    public class CustomBillDetailColumnMap : EntityTypeConfiguration<CustomBillDetailColumn>
    {
        public CustomBillDetailColumnMap()
        {
            // Primary Key
            this.HasKey(t => t.ID);
            ...
            this.ToTable("CustomBillDetailColumns");
