...
{
    public class CommissionBillMap : EntityTypeConfiguration<CommissionBill>
    {
        public CommissionBillMap()
        {
            // Primary Key
            this.HasKey(t => new { t.BillNumberId, t.Type, t.ID, t.IsUnit2, t.UnitID, t.NUnitID, t.MUnitID, t.CargoID, t.PriceStyle });
            ...
            this.Property(t => t.BQTY).HasColumnName("BQTY");
            this.Property(t => t.OldBillid).HasColumnName("OldBillid");
