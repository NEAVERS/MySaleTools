...
{
    public class ModifyLog_AppraisalBillMap : EntityTypeConfiguration<ModifyLog_AppraisalBill>
    {
        public ModifyLog_AppraisalBillMap()
        {
            // Primary Key
            this.HasKey(t => new { t.BillNumberId, t.orderid });
            ...
            this.ToTable("ModifyLog_AppraisalBill");
