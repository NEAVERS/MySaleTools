...
{
    public class InOutstocktableMap : EntityTypeConfiguration<InOutstocktable>
    {
        public InOutstocktableMap()
        {
            // Primary Key
            this.HasKey(t => new { t.BillNumberId, t.BillType, t.Audited, t.SortID, t.ItemID, t.IsCombined, t.IsGift, t.IsService });
