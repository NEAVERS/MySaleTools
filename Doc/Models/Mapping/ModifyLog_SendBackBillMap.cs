...
{
    public class ModifyLog_SendBackBillMap : EntityTypeConfiguration<ModifyLog_SendBackBill>
    {
        public ModifyLog_SendBackBillMap()
        {
            // Primary Key
            this.HasKey(t => new { t.BillNumberId, t.ID, t.PriceStyle });
            ...
            this.ToTable("ModifyLog_SendBackBill");
