...
{
    public class AppraisalBillMap : EntityTypeConfiguration<AppraisalBill>
    {
        public AppraisalBillMap()
        {
            // Primary Key
            this.HasKey(t => new { t.BillNumberId, t.ID, t.orderid });
