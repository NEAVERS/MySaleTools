...
namespace Test.Models
{
    public partial class BuyBill
    {
        ...
        public Nullable<decimal> LendBillNumberID { get; set; }
        public Nullable<decimal> LendBillID { get; set; }
        public Nullable<decimal> CompleteTotal { get; set; }
        public Nullable<decimal> NCompleteTotal { get; set; }
        public Nullable<int> AskBillNumberID { get; set; }
        public Nullable<int> AskBillID { get; set; }
    }
}
